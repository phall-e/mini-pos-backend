...
export class TelegramController {
  ...
  ): Promise<PaginatedResponse<TelegramEntity, TelegramResponseDto>> {
  ...
  public update(
    ...
    return this.telegramService.update(+id, dto, logMeta);
  }
  ...
  public remove(
    ...
    return this.telegramService.remove(+id, logMeta);
  }
}
